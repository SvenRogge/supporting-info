...
def get_cv(ff):
    ...
    l1 = [i for i in ls[1] if not ff.system.numbers[i]==8] # remove oxygens to enforce equal COM for alternating layer
    l2 = [i for i in ls[2] if not ff.system.numbers[i]==8] # remove oxygens to enforce equal COM for alternating layer
    layers = [l1,l2]
